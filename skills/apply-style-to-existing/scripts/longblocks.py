"""Reports docstring paragraphs that run past a sentence ceiling.
...
Usage: longblocks.py [--show] [--limit N] [path]... , defaulting to src.
...
LIMIT = 3  # a default, not a standard: set --limit N from your own style
